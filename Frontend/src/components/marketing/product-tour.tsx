...
const TOUR = [
  {
    src: "/screenshots/week-calendar.jpg",
  ...
  {
    src: "/screenshots/approval-request.jpg",
    alt: "מסך היומן עם בקשת תור אחת הממתינה לאישור, וכפתורי אישור ודחייה",
    Icon: MessageCircle,
  ...
  return (
    <div className="mx-auto w-full max-w-[1400px] px-5 sm:px-8">
      <ul className="space-y-20 sm:space-y-28">
        {TOUR.map(({ src, alt, Icon, title, body, points }, i) => (
          <li
            key={src}
          ...
          >
            ...
            <div className={i % 2 === 1 ? "lg:order-last" : undefined}>
              <PhoneFrame
                ...
                sizes="(min-width: 1024px) 304px, (min-width: 640px) 40vw, 80vw"
              />
            </div>
